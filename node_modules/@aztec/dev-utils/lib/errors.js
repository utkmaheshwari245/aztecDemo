...
/*#__PURE__*/
function (_Error) {
  _inherits(AztecError, _Error);

  function AztecError(code, data) {
    var _this;

    _classCallCheck(this, AztecError);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AztecError).call(this, code));
    _this.data = data;
    return _this;
  }
